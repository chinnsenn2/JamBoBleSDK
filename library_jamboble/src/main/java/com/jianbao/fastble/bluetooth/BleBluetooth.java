package com.jianbao.fastble.bluetooth;
...
import com.jianbao.fastble.callback.BleIndicateCallback;
import com.jianbao.fastble.callback.BleMtuChangedCallback;
import com.jianbao.fastble.callback.BleNotifyCallback;
import com.jianbao.fastble.callback.BleReadCallback;
import com.jianbao.fastble.callback.BleRssiCallback;
import com.jianbao.fastble.callback.BleWriteCallback;
import com.jianbao.fastble.data.BleConnectStateParameter;
import com.jianbao.fastble.data.BleDevice;
import com.jianbao.fastble.data.BleMsg;
import com.jianbao.fastble.exception.ConnectException;
import com.jianbao.fastble.exception.OtherException;
import com.jianbao.fastble.exception.TimeoutException;
import com.jianbao.fastble.utils.BleLog;
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            for (Map.Entry<String, BleNotifyCallback> entry : bleNotifyCallbackHashMap.entrySet()) {
                BleNotifyCallback callback = entry.getValue();
                if (callback != null) {
            ...
            for (Map.Entry<String, BleIndicateCallback> entry : bleIndicateCallbackHashMap.entrySet()) {
                BleIndicateCallback callback = entry.getValue();
                if (callback != null) {
                    if (characteristic.getUuid().toString().equalsIgnoreCase(callback.getKey())) {
                        Handler handler = callback.getHandler();
                        if (handler != null) {
